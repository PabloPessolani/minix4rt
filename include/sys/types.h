...
typedef int			param_t;
typedef unsigned long	lcounter_t;
typedef unsigned int	scounter_t;
typedef unsigned int	irq_mask_t;		
typedef int			proc_nbr_t;		
typedef unsigned char	priority_t;		
typedef char		irq_type_t;
typedef unsigned int	bitmap16_t;
typedef unsigned long	bktbmap_t;
#endif	

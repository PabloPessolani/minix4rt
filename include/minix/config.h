...
#define ENABLE_MINIX4RT    1	/* enable MINIX4RT TASK */
...
#ifdef MRT
#define NR_VTIMERS	16			/* number of virtual timers 		*/
#define NR_MESSAGES	32			/* number of message descriptors 	*/
#define NR_MSGQ		16			/* number of message queues desc 	*/
#define NR_SEM		16			/* number of RT Semaphores desc 	*/
#endif /* MRT */

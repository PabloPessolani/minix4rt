...
#ifdef MRT
typedef struct {char m7ca1[M7_STRING];} mess_7;
#endif
...
#ifdef MRT
struct mrtinfo {		/* information for the mrtstat(1) program */
	u16_t		nr_vtimers; 
	u16_t     	nr_prty;	
	u16_t     	nr_irq_vectors;
	u16_t     	nr_irq_soft;
	u16_t     	nr_msgq;
	u16_t     	nr_messages;
	u16_t     	nr_sem;

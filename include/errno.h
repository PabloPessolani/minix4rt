...
#ifdef MRT
#define E_MRT_BADIRQ  	-2001	/* BAD IRQ Number 				*/
#define E_MRT_BADTASK  	-2002	/* BAD TASK Number 				*/
#define E_MRT_BADPRTY  	-2003	/* BAD Priority 					*/
#define E_MRT_BADIRQT  	-2004	/* BAD IRQ handler type 			*/
#define E_MRT_BADHARM 	-2005	/* BAD Timer harmonic    			*/
#define E_MRT_RTACTIVE	-2006	/* Some RT process or handler is Active 	*/
#define E_MRT_BADPTYPE	-2007	/* BAD process type 				*/
#define E_MRT_BADPER	-2008	/* BAD period  					*/
#define E_MRT_BADDEAD	-2009	/* BAD Deadline  					*/
#define E_MRT_BADWDOG   -2010	/* BAD Watchdog process ID			*/
#define E_MRT_UNREADY   -2011	/* The process is UNREADY			*/
#define E_MRT_NOVTIMER  -2012	/* There is not free Virtual Timer 		*/
#define E_MRT_NOSOFTIRQ -2013 /* There is not free Software IRQ         */
#define E_MRT_NORTMODE  -2014 /* The system is not in RT mode           */
#define E_MRT_UNSLEEP   -2015	/* The process is UNSLEEPed			*/
#define E_MRT_EXITING   -2016	/* A related process is exiting 		*/
#define E_MRT_NOMQENT   -2017	/* The aren't available msgq entries 	*/
#define E_MRT_BADMQSZ	-2018	/* BAD Message Queue Size			*/
#define E_MRT_NOMSGQ    -2019	/* There aren't sufficient msgq entries 	*/
#define E_MRT_BADMSGT   -2020	/* BAD Message Type				*/
#define E_MRT_TIMEOUT   -2021	/* A timeout has expired			*/
#define E_MRT_RTMODE    -2022 /* The system is in RT mode	            */
#define E_MRT_BADRFSH 	-2023	/* BAD Refresh count    			*/
#define E_MRT_MQFULL 	-2024	/* The dest msgQ is full			*/
#define E_MRT_NOSEM     -2025	/* There is not free Semaphore 		*/
#define E_MRT_BADSEM    -2026	/* The Semaphore does not exists		*/
#define E_MRT_FREESEM   -2027	/* The Semaphore is free			*/
#define E_MRT_BADNAME	-2028	/* The name exists/not exists			*/
#define E_MRT_BADVALUE 	-2029	/* Bad Value 			  		*/
#define E_MRT_BADFLAGS 	-2030	/* Bad Flags			  		*/
#define E_MRT_BADMSGQ   -2031	/* The Message Queue does not exists	*/
#define E_MRT_FREEMSGQ  -2032	/* The The Message Queue is free		*/

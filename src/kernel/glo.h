...
#ifdef MRT
#define irq_use  MRT_si.hard_use	 
#else
...
EXTERN int 			pport;		/* SOLO PARA PRUEBA, SUPRIMIR ver PRINTER.C */
EXTERN int 			dbg;			/* SOLO PARA PRUEBA, SUPRIMIR */

EXTERN MRT_sysval_t	MRT_sv;
EXTERN MRT_sysirq_t 	MRT_si;
EXTERN MRT_sysproc_t 	MRT_sp;
EXTERN MRT_systmr_t	MRT_st;
EXTERN MRT_sysmsg_t	MRT_sm;
EXTERN MRT_syssem_t     MRT_ss;

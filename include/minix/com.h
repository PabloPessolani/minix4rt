...
#ifdef MRT
#define RTKCALL		   4	/* function code for RT Kernel Calls */

#define NRTKCALLS		   14

/* RT KERNEL operation code (function) numbers */
#define MRTSET2RT		   0 	/* function code to set a RT process after MRT_SETPROC*/
#define MRTSET2NRT	   1	/* function code to set a NRT process before exit 	*/
#define MRTSLEEP		   2	/* function code to block a running RT-process 		*/
#define MRTWAKEUP		   3  /* function code to wakeup a blocked RT-process 	*/

#define MRTPRINT		   4	/* function code to print a string in the system cons */

#define MRTRQST		   5	/* function code to send Synchronous Request RT-msgs	*/
#define MRTREPLY		   6  /* function code to send Reply   RT-messages 		*/
#define MRTARQST	  	   7	/* function code to send Asynchronous Request RT-msgs */
#define MRTUPRQST		   8	/* function code to send and UP request 			*/
#define MRTSIGN		   9	/* function code to send a SIGNAL message 		*/
#define MRTRCV	   	  10	/* function code to Receive RTmessages 			*/
#define MRTRQRCV	   	  11	/* function code to Request and then Receive RT-msgs  */

#define MRTSEMUP	   	  12	/* function code to Up a Semaphore				*/
#define MRTSEMDOWN   	  13	/* function code to Down a Semaphore			*/

/* parameters name used by MRTTASK in mrttask.c */
#define CALLER         m1_i1	/* caller process */

#define IRQNBR         m1_i2	/* irq number */
#define HARMONIC       m1_i2	/* MINIX4RT Timer Harmonic (MINIX timer is the 1st Harmonic) */
#define PIDNBR         m1_i2	/* PID number */
#define SEMID          m1_i2	/* Semaphore ID number 		 */
#define FLAGS          m1_i2	/* Flags */
#define MSGQID         m1_i2	/* Message Queue ID number 		 */

#define REFRESH        m1_i3	/* Idle refresh tick counter						*/

#define PIRQATTR       m1_p1	/* pointer to a irq attributes */
#define PIRQSTAT       m1_p1	/* pointer to a irq statistics */
#define PIRQINT        m1_p1	/* pointer to a irq internal fields */

#define PSYSSTAT       m1_p1	/* pointer to a system statistics descriptor */
#define PSYSVAL        m1_p1	/* pointer to a system values     descriptor */

#define PPROCATTR      m1_p1	/* pointer to a process processing attributes */
#define PPROCSTAT      m1_p1	/* pointer to a process statistics descriptor */
#define PPROCINT       m1_p1	/* pointer to a process internals variables   */

#define SEMATTR        m1_p1	/* pointer to a sem attributes */
#define SEMSTAT        m1_p1	/* pointer to a sem statistics */
#define SEMINT         m1_p1	/* pointer to a sem attributes */
#define SEMNAME        m1_p1	/* pointer to a sem name 	 */

#define MSGQSTAT       m1_p1	/* pointer to a message queue statistics */
...
#ifdef MRT
#define WINCHESTER	(MRTTASK - ENABLE_WINI)
				/* winchester (hard) disk class */
#define MRTTASK		(SYN_ALRM_TASK - ENABLE_MINIX4RT)

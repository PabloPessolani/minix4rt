...
#ifdef MRT
	  case SF1:     MRT_patt_dmp(); break;      /* print RT attributes of the process table */
	  case CF1:     MRT_pstat_dmp(); break;     /* print RT statistics of the process table */
	  case SF2:     MRT_counter_dmp(); break;   /* print MINIX4RT counters and values 	*/
	  case F4:      MRT_irq_dmp(); break;       /* print hardware interrupt desc table 	*/
	  case SF4:     MRT_soft_dmp(); break;      /* print software interrupt desc table 	*/
	  case CF4:     MRT_irqQ_dmp(); break;      /* print interrupt pending Queues table */
	  case F5:      MRT_rdyQ_dmp(); break;      /* print priority Queues table 		*/
	  case F6:      MRT_mpool_dmp();break;	  /* print message pool (msg attrib) 	*/
	  case SF6:     MRT_mpool2_dmp();break;	  /* print message pool (msg content) 	*/
	  case CF6:     MRT_msgQ_dmp();break;	  /* print per process message queue 	*/
	  case SF7:     MRT_latency_dmp();break;	  /* latency computation on/off 		*/
	  case F8:      MRT_vtimer_dmp();break;	  /* print virtual timer table 		*/
	  case SF8:     MRT_vtQ_dmp();break;	  /* print virtual timer queues 		*/
	  case F9:      MRT_sem_dmp();break;	  /* print semaphore table			*/
	  case SF9:     MRT_psem_dmp();break;	  /* print allocated semaphores by procs  */
